(function () {
    ...
    const initScript = () => {
        ...
        const GITHUB_VERSION_URL = "https://raw.githubusercontent.com/LombreBlanche34/krunker_kovaaks_sim/refs/heads/main/version";
        const GITHUB_REPO_URL = "https://github.com/LombreBlanche34/krunker_kovaaks_sim";
        ...
        async function checkForUpdate() {
            ...
            if (latestVersion !== VERSION) {
                ...
                alert(`New version for kovaaks_sim.js\nActual: ${VERSION} New: ${latestVersion}\n${change}`)
            }
        }
        checkForUpdate()
